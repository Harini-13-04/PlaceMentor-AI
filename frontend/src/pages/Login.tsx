      ...
      <div className="lg:col-span-6 bg-white dark:bg-[#101322] border-r border-slate-200 dark:border-slate-800/80 p-5 sm:p-8 lg:p-10 xl:p-12 flex flex-col justify-between h-full overflow-hidden">
        <div className="max-w-md w-full mx-auto space-y-4 my-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => setErrorMsg("Google authentication service connected. Please use email & password for demo access.")}
              className="w-full py-2 px-3 rounded-xl border border-slate-200 dark:border-slate-700/60 bg-slate-50 dark:bg-[#141728]/60 hover:bg-slate-100 dark:hover:bg-[#1a1e34] text-slate-800 dark:text-white text-xs font-medium flex items-center justify-center gap-2 transition-colors"
            >
