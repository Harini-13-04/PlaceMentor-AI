      ...
      <div className="lg:col-span-6 bg-white dark:bg-[#101322] border-r border-slate-200 dark:border-slate-800/80 p-4 sm:p-6 lg:p-8 xl:p-10 flex flex-col justify-between h-full overflow-hidden">
        <div className="max-w-md w-full mx-auto space-y-2.5 my-auto">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              type="button"
              onClick={() => setErrorMsg("GitHub registration service connected. Please use email & password for demo access.")}
              className="w-full py-1.5 sm:py-2 px-3 rounded-xl border border-slate-200 dark:border-slate-700/60 bg-slate-50 dark:bg-[#141728]/60 hover:bg-slate-100 dark:hover:bg-[#1a1e34] text-slate-800 dark:text-white text-xs font-medium flex items-center justify-center gap-2 transition-colors cursor-pointer"
            >
